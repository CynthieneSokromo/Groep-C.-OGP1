...
#include "WELCOME.h" //hier implementeer je de welocme stuk in de mainfile
#include "PLAYER.h" //hier implenteer je de player header file in je mainfile
...
private:
    ...
    const vector<string> filenames = {
        "C: / Users / User / Desktop / Images / Card_0.jfif",
              ...
              "C:/Users/User/Desktop/Images/Card_8.jfif"
    };
    const std::string backFilename = "C:/Users/User/Desktop/Images/Back.jfif";
...
int main() {
    ...
    Player* currentPlayer = &player1; // plaatst de current player naar player 1 automatisch

    // switchen van players
...
// Beëindigt het programma succesvol
